    ...
    '/v1/points/summary': {
      get: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired.' },
          404: { description: 'The user id in the token no longer resolves to a user record.' },
          429: {
            description:
    ...
    '/v1/points/trust/{userId}': {
      get: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired.' },
          404: { description: 'No user exists with the given userId.' },
          429: {
            description:
              'Rate limited by the strict limiter applied to the whole /v1/points mount (100 requests ' +
              'per 15 minutes per key).',
    ...
    '/v1/admin/trust/business-rules': {
      get: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired' },
          403: { description: 'Authenticated caller does not hold the admin or super_admin role' },
        },
      },
      patch: {
    ...
    '/v1/admin/trust/risk/{id}': {
      get: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired' },
          403: { description: 'Authenticated caller does not hold the admin or super_admin role' },
          404: { description: 'No risk assessment with that id' },
        },
      },
    },
    ...
    '/v1/admin/trust/partners/{id}': {
      get: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired' },
          403: { description: 'Authenticated caller does not hold the admin or super_admin role' },
          404: { description: 'No institution with that id' },
        },
      },
    },
    ...
    '/v1/admin/trust/points/adjust': {
      post: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired' },
          403: { description: 'Authenticated caller does not hold the admin or super_admin role' },
          404: { description: 'No user with that userId' },
          422: {
            description:
    ...
    '/v1/admin/trust/points/{id}/reverse': {
      post: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or the access token is invalid or expired' },
          403: { description: 'Authenticated caller does not hold the admin or super_admin role' },
          404: { description: 'No ledger entry with that id' },
          409: {
            description:
    ...
    '/v1/custody/locations': {
      get: {
        ...
        responses: {
          ...
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
      post: {
        ...
        responses: {
          ...
          404: { description: 'The institution on the token no longer exists' },
          422: {
            description:
    ...
    '/v1/custody/locations/{id}': {
      delete: {
        ...
        responses: {
          ...
          404: { description: 'No Recovery Point with that id' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    '/v1/custody/locations/{id}/custody': {
      get: {
        ...
        responses: {
          ...
          404: { description: 'No Recovery Point with that id' },
          422: { description: '`status` is not one of the four custody statuses' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    '/v1/custody/staff': {
      ...
      post: {
        ...
        responses: {
          ...
          422: { description: 'Body failed schema validation, e.g. an unrecognised role' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    '/v1/custody/staff/{id}': {
      delete: {
        ...
        responses: {
          ...
          404: { description: 'No staff membership with that id' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    '/v1/custody/custody': {
      post: {
        ...
        responses: {
          ...
          404: { description: 'Unknown institution, Recovery Point, item, or depositing user' },
          409: {
            description:
          ...
          422: { description: 'Body failed schema validation, or the item is not a found item' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    '/v1/custody/custody/{id}/release-code': {
      post: {
        ...
        responses: {
          ...
          404: { description: 'Unknown custody record, institution, Recovery Point, or claimant' },
          409: {
            description: 'The Recovery Point is closed, or the item is no longer in `held` custody',
          },
          422: { description: 'Body failed schema validation (missing or empty `claimantId`)' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    '/v1/custody/custody/{id}/release': {
      post: {
        ...
        responses: {
          ...
          404: { description: 'Unknown custody record, institution or Recovery Point' },
          409: {
            description:
    ...
    '/v1/custody/cases': {
      get: {
        ...
        responses: {
          ...
          422: { description: '`status` is not one of the nine recovery case statuses' },
          429: { description: 'Custody rate limit exceeded (600 requests per 15 minutes)' },
        },
      },
    },
    ...
    '/v1/recoveries/mine': {
      get: {
        ...
        responses: {
          ...
          401: { description: 'Missing, malformed or expired bearer token' },
          429: { description: 'Strict rate limit exceeded (100 requests per 15 minutes)' },
        },
      },
    },
    '/v1/recoveries/{id}': {
      get: {
        ...
        responses: {
          ...
          404: { description: 'No recovery case with that id' },
          429: { description: 'Strict rate limit exceeded (100 requests per 15 minutes)' },
        },
      },
    },
    ...
    '/v1/reward-catalog/{id}/reserve': {
      post: {
        ...
        responses: {
          ...
          401: { description: 'Missing bearer token, or a token that fails verification.' },
          403: { description: "The member's trust level is below the offer's minTrustLevel." },
          404: {
            description:
          ...
          429: { description: 'Public rate limit exceeded — 300 requests per IP per 15 minutes.' },
        },
      },
    },
    '/v1/reward-catalog/manage': {
      ...
      post: {
        ...
        responses: {
          ...
          404: { description: "The institution on the caller's token no longer exists." },
          422: {
            description:
    ...
    '/v1/reward-catalog/manage/{id}': {
      patch: {
        ...
        responses: {
          ...
          409: { description: 'An ended campaign cannot be reopened.' },
          422: {
            description:
