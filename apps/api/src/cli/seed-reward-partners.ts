...
const DEMOS: Demo[] = [
  {
    name: 'Marina Mall',
    type: 'mall',
    description: 'Spend points on gift cards and food-court treats at Ghana’s favourite mall.',
    rate: 3,
    lng: -0.1714,
    lat: 5.6212,
    city: 'Accra',
  ...
  {
    name: 'Chez Clara Restaurant',
    type: 'restaurant',
    description: 'Redeem points for a discount on Ghanaian & continental dishes in Osu.',
    rate: 5,
    lng: -0.182,
    lat: 5.556,
    city: 'Accra',
    logoSeed: 'chezclara',
    website: 'https://example.com/chezclara',
  },
  {
    name: 'Legon Cafe & Roastery',
    type: 'cafe',
    description: 'A free pastry with any coffee when you pay with finder points near campus.',
    rate: 4,
    lng: -0.187,
    lat: 5.6515,
    city: 'Accra',
    logoSeed: 'legoncafe',
    website: 'https://example.com/legoncafe',
  },
  {
    name: 'HealthPlus Pharmacy',
    type: 'pharmacy',
    description: 'Knock points off everyday health and wellness essentials.',
    rate: 2,
    lng: -0.2057,
    lat: 5.6037,
    city: 'Accra',
...
async function main() {
  ...
  for (const d of DEMOS) {
    ...
    const inst = Institution.onboard({
      ...
      name: d.name,
      type: d.type,
      contactEmail: `${d.logoSeed}@partners.bak2me.com`,
      place: {
        name: d.name,
        city: d.city,
        country: 'Ghana',
        point: { type: 'Point', coordinates: [d.lng, d.lat] },
      },
      pointsRedeemable: true,
