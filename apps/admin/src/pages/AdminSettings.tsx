...
const EMAIL_PREFS: { key: keyof EmailPreferences; label: string; desc: string }[] = [
  {
    key: 'matches',
    label: 'Match alerts',
    desc: 'When the AI links a lost report to a found item.',
  },
...
function SettingCard({
  ...
  return (
    ...
    >
      ...
      >
        <Box>
          <Typography sx={{ fontFamily: 'Outfit, sans-serif', fontWeight: 600, fontSize: 20 }}>
            {title}
          </Typography>
          {desc && (
...
function ProfileSection() {
  ...
  return (
    <Stack spacing={2.5}>
      <SettingCard title="Profile" desc="How you appear across the console and in audit trails.">
        <Stack
      ...
      <SettingCard
        title="Email"
        desc="Sign-in identity for this console. Contact a super admin to change it."
        action={
          user.emailVerified ? (
            <Chip
              size="small"
...
function PreferencesSection() {
  ...
  return (
    <Stack spacing={2.5}>
      <SettingCard title="Theme" desc="Choose how the console looks on this device.">
        <ToggleButtonGroup
          exclusive
          value={themeMode}
...
function DataSection() {
  ...
  return (
    <Stack spacing={2.5}>
      ...
      <SettingCard title="Console tour" desc="Replay the guided walkthrough of the console.">
        <Button
          variant="outlined"
          color="inherit"
      ...
      <SettingCard title="Session" desc="Sign out of the operations console on this device.">
        <Button
          onClick={clear}
  ...
  return (
    <Stack spacing={2.5} sx={{ maxWidth: 1100, mx: 'auto', width: '100%' }}>
      <PageHeader
        ...
        title="Settings"
        description="Profile, security, appearance, language and notification controls for your admin account."
      />
      <Box
        sx={{
          display: 'grid',
