...
// These controls live on the permanently dark console chrome. Explicitly pin
// their surface so the light content theme cannot turn them into white discs.
...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    body: 'This quick tour shows you where everything lives. Replay it anytime from the help icon in the top bar or from the account menu.',
  },
  {
  ...
  },
  {
    ...
    title: 'Notifications',
    body: 'Matches, courier updates and redemption events land here. Open the bell for a quick look, or jump to the full inbox.',
  },
  {
    target: '[data-tour="theme-toggle"]',
    title: 'Light or dark',
    body: 'Switch the portal theme in one click. A full theme picker (including “follow system”) lives in Settings → Preferences.',
  },
  {
              ...
              <Tooltip title="Sign out">
                <IconButton
                  ...
                  sx={{
                    ...
                    height: 34,
                    color: MUTED,
                    '&:hover': { ...DARK_HEADER_ACTION['&:hover'], color: '#fff' },
                  }}
                >
    ...
    <>
      ...
      >
        ...
        {isLoading ? (
          ...
          >
            Nothing yet — match, courier and redemption events will show up here.
          </Typography>
        ) : (
        ...
        <Button
          ...
          sx={{ py: 1, borderRadius: 0, fontWeight: 600 }}
        >
...
export function PartnerLayout({ children }: { children: ReactNode }) {
  ...
  // First sign-in on this device: walk new partners through the portal once.
  useEffect(() => {
